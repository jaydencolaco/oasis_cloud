...
const Footer = () => {
  return (
    <footer className="text-black border-t border-gray-200 py-5">
      <div className="container mx-auto flex justify-between gap-6 sm:w-[85%] w-[90%]">
        <div>
          {/* <Link href={"/"}>
            <Image
          ...
          <p className="mb-2  text-gray-500">
            {" "}
            © Oasis Luminaires 2025 | All Rights Reserved
          </p>
        </div>
        ...
        {/* used mainly to create space in footer <div></div> */}
        {/* USEFUL LINKS
         */}

        {/* <div>
          <h3 className="text-[#454343] uppercase tracking-widest font-light mb-2">
            About Us
          </h3>
          <p className="text-sm leading-6">
            Oasis is committed to producing high-quality, long-lasting lighting
            products. Every fixture is crafted to withstand diverse outdoor
            conditions and tested to ensure high performance.{" "}
          </p>
        </div> */}
